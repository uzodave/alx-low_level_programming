 ...
 * @num: variable to be multiplied
 * @num_index: last non-NULL index of num
 * @dest: destination of multiplication
 * @dest_index: highest index to start addition
 * Return: A pointer to dest on success and NULL for failure
 */
 ...
 * Return: 0 if it isa digit and 1 for failure
 */
 ...
 * Return: 0 or exit status of 98 for failure
 */
